...
const SubmitReview = () => {
  ...
  return (
    <div className="">
      ...
      <div className="flex-none lg:flex  mt-8 w-3/4 m-auto">
        <div className="">
          <div className="">
            <div className=" p-7 border-2 m-5 rounded-xl flex-none lg:flex  lg:justify-between shadow-lg">
              ...
              <div className=" font-bold text-left ml-5 ">
                <p className="text-xl text-blue-700 ">$25000</p>
            ...
            <div className="gap-2 border w-3/2 m-5 rounded-xl ">
              ...
              <div className="p-4 ">
                <div className="grid-none lg:grid grid-cols-4   md:divide-x text-center bg-[#E5F8F2] border border-green-300 rounded-xl   divide-dotted divide-green-300">
                  <div className="p-10 md:w-1/4 sm:w-1/2 w-full">
            ...
            {/* submit review */}
            <div className="border rounded-xl m-5 w-3/2 grid grid-col-2">
