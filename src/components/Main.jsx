    ...
    <div className='w-full relative'>
        ...
        <Slider {...settings}>
          ...
          <div className='relative'>
            ...
            <div className='absolute bg-gray-base bg-opacity-50 leading-relaxed text-center left-20 text-2xl w-96 h-96 top-0 rounded pt-64 h-[45rem]'>Join this educational journey <br></br> with us <br></br> and discover your data!</div>
          </div>
