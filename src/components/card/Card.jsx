            ...
            <div className="rounded-lg border shadow-2xl">
              <div className="relative flex h-60 justify-center overflow-hidden rounded-lg">
                <div className="w-full transform transition-transform duration-500">
                  <img
                    src="https://img.freepik.com/free-photo/scientist-chemist-checking-strawberry-using-medical-tweezers-working-biotechnology-laboratory_482257-4551.jpg?w=900&t=st=1689033860~exp=1689034460~hmac=5d58b47d1e529d25493d2d0ad365c8edfd43d6b6015f1e6d634df0821b44620a"
                    alt=""
                  />
