...
const UniCard = ({ key,item }) => {
  ...
  return (
    <div
      className="w-96 container flex flex-col justify-center items-center sm:flex-col sm:justify-start border-2 border-gray-300 rounded-md shadow-lg  lg:mx-auto my-10 sm:mx-auto md:m-20"
      key={key}
    >
      ...
      <div className="">
        <p className="font-bold text-xl mb-2"></p>
