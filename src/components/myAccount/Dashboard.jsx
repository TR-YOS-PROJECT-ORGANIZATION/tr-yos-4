...
const Dashboard = () => {
  return (
    <div className="flex flex-col border h-1/2 justify-center max-w-xs p-6 mt-5 shadow-md rounded-xl sm:px-12 text-dark-900 dark:text-gray-100">
      <img
      ...
      <div className="mt-6">
        <div className="mt-2">
          <a className=" flex text-xs p-2 font-medium border-2 rounded-md text-gray-base  hover:bg-red-retro hover:text-gray">
