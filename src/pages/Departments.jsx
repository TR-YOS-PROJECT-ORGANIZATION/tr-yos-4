  ...
  return (
    <>
      <div className="flex flex-col">
        ...
        <form
          method="POST"
          className=" flex flex-col justify-center items-center w-full sm:flex-col sm:justify-center sm:items-center sm:m-4  md:flex md:flex-row md:px-16 md:justify-center md:items-center"
        >
          <Selections />
          <PriceForm />
          <div className="flex flex-col">
