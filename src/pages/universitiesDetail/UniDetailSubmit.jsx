...
//                     <div className="font-bold text-[#00A372]">{detail[0]?.language}</div>
//                   </div>
//                   <div className="p-10 ">
...
//               <div className=" m-5">
//                 <h4 className="font-bold">About Univercities</h4>
//               </div>
//               <div className="m-3 ">
...
//               <div className="m-5 ">
//                 <h2 className="text-2xl font-bold">u</h2>
    ...
    <div className="">
      ...
      <div className="flex-none lg:flex  mt-8 w-5/6 m-auto">
        ...
        <div className="w-2/3 mt-8">
          <div className="border p-4 rounded-xl mb-12 shadow-2xl">
            <button
            style={{backgroundColor: !show &&  "#00A372",
                    borderStyle:!show &&  "none"
          }}
              className=" bg-red-200 border-2 border-red-warm py-3 p-3 rounded-xl hover:bg-red-warm hover:text-white-500 "
